/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3787b2a6577d531c4ff107cf612dba3b)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	LOADER: WorkerLoader;
	AI: Ai;
	ASSISTANT_MODEL: string;
	AppHost: DurableObjectNamespace<import("./src/server").AppHost>;
	CodeAssistant: DurableObjectNamespace<import("./src/server").CodeAssistant>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "AppHost" | "CodeAssistant";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASSISTANT_MODEL">> {}
}
